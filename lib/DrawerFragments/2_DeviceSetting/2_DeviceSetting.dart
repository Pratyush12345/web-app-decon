          ...
          Row(children: [
            Expanded(
                flex: 3,
                  ...
                  style: TextStyle(
                      color: Colors.white, fontSize: SizeConfig.b * 4.1)),
            ),
        ...
        child: Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(SizeConfig.b * 1.1)),
                  child: TextField(
          ...
          child: MaterialButton(
              onPressed: (){
                Navigator.of(context).push(MaterialPageRoute( 
                  builder: (context)=>Updatelocation(allDeviceList: widget.allDevicesList,)));
              },
              child: Container(
                  padding: EdgeInsets.symmetric(
                      horizontal: SizeConfig.b * 7,
                  ...
                  child: Text('Update Device Location',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: SizeConfig.b * 3.56,
                          fontWeight: FontWeight.w400))))),
