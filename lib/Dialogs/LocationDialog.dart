...
class LocationDialog extends StatefulWidget {
  ...
  LocationDialog({ @required this.cityid, @required this.initalAddress, @required this.initialLatitude, @required this.initialLongitude});
  @override
...
class _LocationDialog extends State<LocationDialog> {
  ...
  TextEditingController _addressController, _latitudeController , _longitudeController;
  ...
  @override
  void initState() {
   _addressController = TextEditingController(text: widget.initalAddress,);
          ...
          child: Column(children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: SizeConfig.b * 7.8),
                Container(
            ...
            Container(
                width: 200,
                child: Text("Are You sure?Location of ${widget.cityid.split("_")[2].replaceAll("D", "Device ")} is :",
            ...
            SizedBox(
                child: MaterialButton(
                    ...
                    onPressed: ()async{
                     ...
                     await getCurrentLocation(position.latitude, position.longitude);
                     }
                     else{
                     await getCurrentLocation(double.parse(_latitudeController.text.toString()), double.parse(_longitudeController.text.toString()));
                     }
                    ...
                    child: Container(
                        ...
                        child: Text(!_isChanged? 'Get Current Location':'Fetch Location',
                            style: TextStyle(
                                color: Colors.white,
                ...
                SizedBox(
                    child: MaterialButton(
                        ...
                        onPressed: ()async{
                          ...
                          await FirebaseDatabase.instance.reference().child("cities/${widget.cityid.split("_")[0]}/Series/${widget.cityid.split("_")[1]}/Devices/${widget.cityid.split("_")[2]}")
                          .update({
                            "latitude": _lat,
                            "longitude":_lon,
            ...
            SizedBox(width: SizeConfig.v * 2.0),
              SizedBox(
                child: MaterialButton(
                    padding: EdgeInsets.zero,
                    onPressed: (){
